...
HD_PWD='C:/Users/adity/Desktop/WATER/basic_algo64x64/basic_algo64x64.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_simulation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_simulation.tcl -notrace
