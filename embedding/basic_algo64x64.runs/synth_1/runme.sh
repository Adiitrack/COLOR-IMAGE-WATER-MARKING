...
HD_PWD='C:/Users/adity/Desktop/WATER/basic_algo64x64/basic_algo64x64.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_simulation.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_simulation.tcl
